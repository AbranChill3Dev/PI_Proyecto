        ...
        niveles: [
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué canción fue el éxito principal de Shakira en este Mundial?", respuestas: ["Waka Waka", "La La La (Brazil 2014)", "Hips Don't Lie", "Loca"], correcta: 1 } // CANCION EXTRA
                ]
            },
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué artista cantó 'Live It Up', la canción oficial de Rusia 2018?", respuestas: ["Nicky Jam y Will Smith", "Ricky Martin", "Maluma", "J Balvin"], correcta: 0 } // CANCION EXTRA
                ]
            },
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué famosa canción se hizo tradición cantar en el Estadio Azteca desde el mundial de 1986?", respuestas: ["El Rey", "La Bamba", "Cielito Lindo", "La Ola Verde"], correcta: 3 } // CANCION EXTRA
                ]
            }
        ]
    },
        ...
        niveles: [
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué famoso himno se popularizó en el mundial de Italia 90?", respuestas: ["Un'estate italiana", "Bella Ciao", "Gloria", "Volare"], correcta: 0 } // CANCION EXTRA
                ]
            },
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué canción de la banda BTS sonó en la inauguración de Qatar 2022?", respuestas: ["Dynamite", "Butter", "Dreamers", "Fake Love"], correcta: 2 } // CANCION EXTRA
                ]
            }
        ]
    },
        ...
        niveles: [
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué canción de The White Stripes usan los mexicanos para corear a 'Chucky' Lozano?", respuestas: ["Seven Nation Army", "Fell In Love With a Girl", "Icky Thump", "Blue Orchid"], correcta: 0 } // CANCION EXTRA
                ]
            }
        ]
    },
        ...
        niveles: [
            {
                ...
                preguntas: [
                    ...
                    { pregunta: "¿Qué mascota estaba formada por bloques y tuvo su propia música de 8-bits en Italia 90?", respuestas: ["Ciao", "Pique", "Naranjito", "Gauchito"], correcta: 0 } // CANCION EXTRA
                ]
            }
        ]
    }
...
function iniciarJuego(indiceNivel) {
    preguntasActuales = categoriaActiva.niveles[indiceNivel].preguntas;
    indicePregunta = 0;
    puntaje = 0;
